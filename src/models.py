...
class cnn_base(nn.Module):
    def __init__(self, args, input_dim, num_labels):
    ...
    def get_parameter(self, base_lr) -> "Parameter":
        return [
            {"params": self.mbert.parameters(), "lr": base_lr},
            {"params":self.conv1.parameters(),"lr":self.args.alpha*base_lr},
            {"params": self.conv2.parameters(), "lr": self.args.alpha * base_lr},
            {"params": self.conv3.parameters(), "lr": self.args.alpha * base_lr},
            {"params": self.linear1.parameters(), "lr": self.args.alpha * base_lr},
            {"params": self.mlp.parameters(), "lr": self.args.alpha * base_lr},
            {"params": self.linear2.parameters(), "lr": self.args.alpha * base_lr},
            {"params": self.lstm.parameters(), "lr": self.args.alpha * base_lr},
            {"params": self.classifier.parameters(), "lr": self.args.alpha * base_lr}
        ]
...
class mroberta_cnn(nn.Module):
    def __init__(self, args, input_dim, num_labels):
        super(mroberta_cnn, self).__init__()
        self.args = args
        self.config = XLMRobertaConfig()
        self.num_labels = num_labels
        self.input_dim = input_dim
